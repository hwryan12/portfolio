    ...
    return (
        <Modal show={show} onHide={handleClose} className={styles.aboutModal}>
            ...
            <Modal.Body>
                ...
                <p>Howdy! I'm Harrison, a former Alaskan boat captain turned software developer. I've traded the icy waves for a different kind of adventure; navigating the uncharted territories of being a new dad.</p>
                <p>When I'm not reminiscing about my seafaring days, you'll find me enjoying the outdoors hiking, or masterfully orchestrating epic adventures in a game of D&D. My voyage from the helm to the home has taught me so much about teamwork and clear communication.</p>
